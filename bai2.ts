...
let numbers = ["0942903433", "0383299536","0372792019", "0856789012"]
let viettel = []
    let vina = []
    let mobi = []

    for (let i = 0;i<numbers.length;i++) {
        let scum = numbers[i].substring(0,3)
        switch (scum) {
            case "089":
            case "090":
            case "093":
...
break;
            default:
                console.log("Số điện thoại không thuộc bất kỳ nhà mạng nào là: "+numbers[i]);
                break;
        }
